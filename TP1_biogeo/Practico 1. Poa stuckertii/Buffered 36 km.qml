...
<qgis styleCategories="AllStyleCategories" simplifyDrawingTol="1" version="3.10.0-A Coruña" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" readOnly="0" simplifyAlgorithm="0" simplifyLocal="1" maxScale="0" labelsEnabled="0" simplifyMaxScale="1" minScale="1e+08">
  <flags>
  ...
  <renderer-v2 enableorderby="0" type="singleSymbol" forceraster="0" symbollevels="0">
    <symbols>
      <symbol alpha="0.562" type="fill" clip_to_extent="1" force_rhr="0" name="0">
  ...
  <DiagramLayerSettings dist="0" linePlacementFlags="18" zIndex="0" obstacle="0" placement="1" priority="0" showAll="1">
    <properties>
      <Option type="Map">
        <Option value="" type="QString" name="name"/>
        <Option name="properties"/>
